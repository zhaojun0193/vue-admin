<template>
    <div id="login">
        <div class="login-wrap">
            <ul class="menu-tab">
                <li :class="{'current': item.isActive}" v-for="item in menuTab" :key="item.id"
            ...
            <el-form :model="ruleForm" status-icon :rules="rules" ref="ruleForm" class="login-form">
                ...
                <el-form-item prop="checkPass" class="item-form" v-if="ruleForm.isShowCheckPass">
                    <label>重复密码</label>
                    <el-input type="password" v-model="ruleForm.checkPass" autocomplete="off" size="medium"
                ...
                <el-form-item prop="vCode" class="item-form">
                    ...
                    <el-row :gutter="10">
                        <el-col :span="15">
                            <el-input v-model.number="ruleForm.vCode" size="medium" minlength='6'
    ...
    export default {
        ...
        methods: {
            toggleMenu(data) {
                ...
                data.isActive = true;
                this.ruleForm.isShowCheckPass = data.txt === '注册';
            },
            submitForm(formName) {
